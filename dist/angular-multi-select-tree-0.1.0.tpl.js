angular.module('multi-select-tree').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('src/multi-select-tree.tpl.html',
    ...
    "\r" +
    "\n" +
    "    <div class=\"tree-input\" ng-click=\"onControlClicked($event)\">\r" +
    "\n" +
    ...
    "    <span ng-if=\"selectedItems.length > 0\" class=\"selected-items\">\r" +
    "\n" +
    "      <span ng-repeat=\"selectedItem in selectedItems\" class=\"selected-item\">{{selectedItem.name}} <span class=\"selected-item-close\"\r" +
    "\n" +
    "                                                                                  ng-click=\"deselectItem(selectedItem, $event)\"></span></span>\r" +
    "\n" +
    ...
    "\n" +
    "             <div class=\"line\" data-ng-if=\"switchView\">\r" +
    "\n" +
    "                 <button type=\"button\" ng-click=\"switchCurrentView($event);\" class=\"helper-button\">{{switchViewLabel}}</button>\r" +
    "\n" +
    "             </div>\r" +
    "\n" +
    "            <div class=\"line\">\r" +
    ...
    "\n" +
    "                <span class=\"clear-button\" ng-click=\"clearFilter($event)\"><span class=\"item-close\"></span></span>\r" +
    "\n" +
    "            </div>\r" +
    "\n" +
    "        </div>\r" +
    ...
    "\n" +
    "                       on-active-item=\"onActiveItem(item)\" select-only-leafs=\"selectOnlyLeafs\"></tree-item>\r" +
    "\n" +
    "        </ul>\r" +
    "\n" +
    "    </div>\r" +
  ...
  $templateCache.put('src/tree-item.tpl.html',
    ...
    "    </div>\r" +
    "\n" +
    "    <ul ng-repeat=\"child in item.children\" ng-if=\"item.isExpanded\" ng-show=\"!child.isFiltered\">\r" +
    "\n" +
